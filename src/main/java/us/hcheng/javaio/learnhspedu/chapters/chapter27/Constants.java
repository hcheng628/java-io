...
public class Constants {
	...
	public static final String JAVA_TXT = "1995年，互联网的蓬勃发展给了Oak机会。业界为了使死板、单调的" +
	...
	public static final String IP_ADDR_TXT = "私有地址（Private address）属于非注册地址，专门为组织机构内部使用。\n" +
			"以下列出留用的内部私有地址\n" +
			"A类 10.0.0.0--10.255.255.255\n" +
			"B类 172.16.0.0--172.31.255.255\n" +
			"C类 192.168.0.0--192.168.255.255";
	public static final String HEADLINES_TXT = "<div class=\"cr-content  new-pmd\">\n" +
			"    \n" +
			"<div class=\"FYB_RD\">\n" +
